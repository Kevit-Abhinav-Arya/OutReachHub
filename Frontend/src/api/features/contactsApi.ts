...
import type { Contact, CreateContactDto, UpdateContactDto, GetContactsQuery } from '@/features/user-portal/contacts/types/contact.types';
...
export const contactsApi = {
  ...
  getContacts: async (query: GetContactsQuery = {}): Promise<ContactsListResponse> => {
  ...
  updateContact: async (id: string, contactData: UpdateContactDto): Promise<Contact> => {
